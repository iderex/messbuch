...
Each of these was on the list and none of them survived the rule. The argument
against each one is below, so the next person to propose it can read the
argument instead of having it again.
